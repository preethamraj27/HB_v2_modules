...
exports.parseMultipleMQTTSetTopicsProperty = exports.parseMQTTSetTopicProperty = exports.parseMQTTGetTopicProperty = exports.parseMQTTSubscriptions = exports.parseMQTTOptions = exports.parseMultipleUrlProperty = exports.parseUrlProperty = exports.parsePattern = exports.MQTTPublishObject = exports.MQTTSubscribeObject = exports.UrlObject = void 0;
class UrlObject {
    constructor(url) {
        this.method = "GET";
        this.body = "";
        this.repeat = 1;
        this.delayBeforeExecution = 0;
        this.auth = {
            username: undefined,
            password: undefined,
        ...
        this.requestTimeout = 20000; // default 20s timeout
        this.url = url;
    }
}
...
class MQTTSubscribeObject {
    constructor(topic) {
        this.qos = 0; // TODO should the default be 1?
        this.patternGroupToExtract = 1; // when non bool characteristic this is used to extract the value of the regex pattern
        this.topic = topic;
    }
}
exports.MQTTSubscribeObject = MQTTSubscribeObject;
...
exports.MQTTPublishObject = MQTTPublishObject;
/* ------------------------------------------ */
function parsePattern(property) {
...
function parseUrlProperty(property) {
...
exports.parseUrlProperty = parseUrlProperty;
function parseMultipleUrlProperty(property) {
    let array = [];
    if (typeof property === "string") {
...
exports.parseMultipleUrlProperty = parseMultipleUrlProperty;
function _parseUrlObject(property) {
    if (!property.url)
...
function parseMQTTOptions(property) {
    ...
    if (property.will !== undefined) {
        mqttOptions.will = {
            topic: property.will.topic,
            payload: property.will.payload,
            qos: (property.will.qos !== undefined ? Math.abs(property.will.qos % 3) : 0),
            retain: property.will.retain || false
        };
    }
...
exports.parseMQTTOptions = parseMQTTOptions;
function parseMQTTSubscriptions(property) {
    if (typeof property !== "object")
...
exports.parseMQTTSubscriptions = parseMQTTSubscriptions;
function _parseMQTTSubscriptionObject(property) {
    if (typeof property !== "object")
    ...
    let subscription = {
        ...
        qos: (property.qos !== undefined ? Math.abs(property.qos % 3) : 1),
...
function parseMQTTGetTopicProperty(property) {
    if (typeof property === "string") {
...
exports.parseMQTTGetTopicProperty = parseMQTTGetTopicProperty;
function parseMQTTSetTopicProperty(property) {
...
exports.parseMQTTSetTopicProperty = parseMQTTSetTopicProperty;
function parseMultipleMQTTSetTopicsProperty(property) {
    let array = [];
    if (typeof property === "string") {
...
exports.parseMultipleMQTTSetTopicsProperty = parseMultipleMQTTSetTopicsProperty;
function _parseMQTTSetTopicObject(property) {
    if (property.topic === undefined)
        throw new Error("'topic' is required!");
    if (typeof property.topic !== "string")
        throw new Error("'topic' must be a string!");
