...
function enqueueNotificationRegistrationIfDefined(api, log, notificationID, notificationPassword, handler) {
    if (notificationID) {
...
exports.enqueueNotificationRegistrationIfDefined = enqueueNotificationRegistrationIfDefined;
