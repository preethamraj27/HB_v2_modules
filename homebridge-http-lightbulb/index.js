...
function HTTP_LIGHTBULB(log, config) {
    ...
    this.statusCache = new Cache(config.statusCache, 90 *1000);
    this.brightnessCache = new Cache(config.brightnessCache, 90 *1000);
    this.hueCache = new Cache(config.hueCache, 90 *1000);
    this.saturationCache = new Cache(config.saturationCache, 90 *1000);
    this.colorTemperatureCache = new Cache(config.colorTemperatureCache, 90 *1000);
